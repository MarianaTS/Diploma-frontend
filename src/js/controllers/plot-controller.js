app.controller('plotController', function($scope, $http, constantsService) {
...
$scope.getResult = function (startX, startY, endX, endY, h) {

    constantsService.getResultList(startX, startY, endX, endY, h).then(function(response) {
        $scope.result = response.data;
        console.log(response.data);
    });
};

$scope.sendToEmail = function (email, result) {
    constantsService.sendToEmail(email, result).then(function(response) {
